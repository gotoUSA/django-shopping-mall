...
class TestOrderAuthentication:
    ...
    def test_authenticated_user_can_view_order_list(
        self, authenticated_client: pytest.fixture, user: User, product: pytest.fixture
    ) -> None:
    ...
    def test_unauthenticated_cannot_view_order_detail(
        self, api_client: pytest.fixture, user: User, product: pytest.fixture
    ) -> None:
...
class TestOrderEmailVerification:
    ...
    def test_unverified_user_cannot_create_order(
        self, api_client: pytest.fixture, product: pytest.fixture, shipping_data: dict
    ) -> None:
...
class TestOrderOwnership:
    ...
    def test_user_can_view_own_orders_only(
        self, authenticated_client: pytest.fixture, user: User, seller_user: User, product: pytest.fixture
    ) -> None:
        """사용자는 본인 주문만 조회"""
    ...
    def test_user_cannot_view_others_order_detail(
        self, authenticated_client: pytest.fixture, seller_user: User, product: pytest.fixture
    ) -> None:
...
class TestAdminOrderPermissions:
    ...
    def test_admin_can_view_all_orders(
        self, api_client: pytest.fixture, user: User, seller_user: User, product: pytest.fixture
    ) -> None:
        """관리자는 모든 주문 조회 가능"""
        # Arrange - 관리자 생성
    ...
    def test_admin_can_view_any_order_detail(self, api_client: pytest.fixture, user: User, product: pytest.fixture) -> None:
    ...
    def test_admin_sees_correct_order_count(self, api_client: pytest.fixture, user: User, seller_user: User) -> None:
        """관리자는 정확한 주문 개수를 확인"""
        # Arrange - 관리자 생성
        admin = User.objects.create_user(
            username="admin3",
    ...
    def test_admin_sees_orders_from_multiple_users(self, api_client: pytest.fixture, user: User, seller_user: User) -> None:
